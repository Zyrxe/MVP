    ...
    GovernorTimelockControlUpgradeable
{
    ...
    function initialize(
        ...
        __Governor_init("ALONEAGovernance");
        __GovernorSettings_init(1, 50400, 0); // 1 block voting delay, ~1 week voting period, 0 proposal threshold
